...
public:
    ...
    ~ExamplePythonTypes() {
        lout << "Destructing ExamplePythonTypes" << std::endl;
    }
    ...
    void print_list(py::list list) {
        int index = 0;
        for (auto item : list)
            lout << "list item " << index++ << ": " << item << std::endl;
    }
    ...
    void print_array(std::array<std::string, 2> &array) {
        int index = 0;
        for (auto item : array)
            lout << "array item " << index++ << ": " << item << std::endl;
    }
