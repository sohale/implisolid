...
public:
    ...
    void eval_implicit(const vectorized_vect& x, vectorized_scalar* f_output, REAL grid_real_size) const {
        int output_ctr = 0;
        auto i = x.begin();
        auto e = x.end();
    ...
    void eval_gradient(const vectorized_vect& x, vectorized_vect* output, REAL grid_real_size) const {
        int output_ctr = 0;
        auto i = x.begin();
        auto e = x.end();
    }
