    ...
    )
{
    ...
    if (writing_test_file) {
        ...
        writing_test_file_("/home/solene/Desktop/mp5-private/implisolid/python_clean_code/data_algo_cpp.txt",  result_verts, result_faces, new_verts, centroids );
    ...
    )
{
    ...
    if (!writing_test_file) {
          ...
          ofstream f_out = debug_part_1("/home/solene/Desktop/mp5-private/implisolid/python_clean_code/data_algo_cpp.txt", copy_of_verts_before_relaxation);
